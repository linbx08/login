...
class SignInViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let viewModel = SignInViewModel(input: (username: usernameTF.rx.text.orEmpty.asDriver(), password: passwordTF.rx.text.orEmpty.asDriver(), signInTap: signInBtn.rx.tap.asDriver()), dependency: (API: GithubAPIProvider, other: "other dependency"))
